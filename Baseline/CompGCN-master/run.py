...
if __name__ == '__main__':
	...
	parser.add_argument('-gcn_drop',	dest='dropout', 	default=0.0,  	type=float,	help='Dropout to use in GCN Layer')
	parser.add_argument('-hid_drop',  	dest='hid_drop', 	default=0.0,  	type=float,	help='Dropout after GCN')
	# ConvE specific hyperparameters
	parser.add_argument('-hid_drop2',  	dest='hid_drop2', 	default=0.0,  	type=float,	help='ConvE: Hidden dropout')
	parser.add_argument('-feat_drop', 	dest='feat_drop', 	default=0.0,  	type=float,	help='ConvE: Feature Dropout')
