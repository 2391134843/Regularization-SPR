...
def get_logger(name, log_dir, config_dir):
    """
    Creates a function to print log messages
    ...
    Returns
    -------
    A function that prints log messages to both file and stdout
    """
    # Ensure log_dir exists
    os.makedirs(log_dir, exist_ok=True)

    # Define the log file path
    log_file_path = os.path.join(log_dir, name.replace('/', '-'))

    # Define a function to print log messages
